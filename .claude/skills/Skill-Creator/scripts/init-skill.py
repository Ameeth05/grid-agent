...
Usage:
    init-skill.py <skill-name>

Examples:
    python .claude/skills/Skill-Creator/scripts/init-skill.py my-new-skill
    python .claude/skills/Skill-Creator/scripts/init-skill.py my-api-helper
...
# Script is at: .claude/skills/Skill-Creator/scripts/init-skill.py
...
def init_skill(skill_name):
    ...
    try:
        ...
        # Set executable permission on Unix-like systems only
        ...
        print("[OK] Created templates/example_template.txt")
    except Exception as e:
